...
//VIP: run the following to add the oledbconnection
//dotnet add package System.Data.OleDb --version 7.0.0
	...
	public partial class Form1 : Form
	{
		...
		private void Search()
		{
			...
			if (SearchString.Length > 0)
			{
				...
				string PdfOnly = chkPdfOnly.Checked ? @"scope ='file:C:\Users\Administrator\Downloads\eMule\Incoming' and" : "";
		...
		private static DataTable getDataTable(string SearchString, string top30, string PdfOnly)
		{
			...
			{
				connection.Open();
				string query = @"SELECT " + top30 + @" System.ItemName, System.ItemPathDisplay, System.Search.HitCount FROM SystemIndex WHERE " + PdfOnly + @" CONTAINS( *, '" + SearchString + "') ORDER BY HitCount DESC";
